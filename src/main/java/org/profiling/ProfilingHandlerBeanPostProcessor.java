...
public class ProfilingHandlerBeanPostProcessor implements BeanPostProcessor {
    ...
    public ProfilingHandlerBeanPostProcessor(ProfilingProperties profilingProperties) {
    ...
    private Object createCGLibProxy(Object target, Class<?> targetClass) {
        ...
        enhancer.setCallback(new ProfilingMethodInterceptor(targetClass, target, profilingProperties));
